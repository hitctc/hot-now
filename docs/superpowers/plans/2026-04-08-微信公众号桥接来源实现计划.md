...
**Files:**
- Modify: `docs/superpowers/specs/2026-04-08-微信公众号桥接来源设计文档.md` (only if implementation forces a design correction)
- Modify: `docs/superpowers/plans/2026-04-08-微信公众号桥接来源实现计划.md` (check off steps while executing)
...
```bash
git add docs/superpowers/specs/2026-04-08-微信公众号桥接来源设计文档.md \
  docs/superpowers/plans/2026-04-08-微信公众号桥接来源实现计划.md
