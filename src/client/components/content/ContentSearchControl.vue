...
const rootClass = computed(() =>
  props.compact
    ? "flex w-full items-center gap-2 rounded-editorial-md border border-editorial-border bg-editorial-panel/70 px-2 py-2 shadow-none sm:rounded-editorial-lg sm:px-3 sm:py-3 sm:shadow-editorial-card"
