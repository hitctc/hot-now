...
const themes: Record<WechatThemeId, WechatTheme> = {
  classic: {
    ...
    name: "默认",
    styles: {
      container: `max-width: 100%; margin: 0 auto; padding: 0; word-break: break-word; color: #000; background-color: transparent;`,
      ...
      img: "display: block; margin: 0px auto; width: 100%; border: 1px solid #ddd;",
  ...
  "black-gold": {
    ...
    styles: {
      ...
      h1: "margin: 0px; font-size: 26px; font-weight: normal; color: #000; text-align: center; letter-spacing: 3px; border-bottom: 1px solid #000; padding-bottom: 20px; display: block;",
      h2: "margin: 0px; font-size: 19px; font-weight: normal; color: #9E8045; text-align: center; display: inline-block; border-top: 1px solid #9E8045; border-bottom: 1px solid #9E8045; padding: 10px 24px; letter-spacing: 1px;",
      ...
      ul: "margin: 10px 0; padding-left: 20px; list-style-type: square; color: #9E8045;",
      ol: "margin: 10px 0; padding-left: 20px; list-style-type: decimal; color: #9E8045;",
      li: "margin: 0 0 6px 0; color: #444; font-weight: normal; line-height: 2.0;",
