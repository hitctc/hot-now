...
const themes: Record<WechatThemeId, WechatTheme> = {
  ...
  "black-gold": {
    ...
    styles: {
      ...
      h2: "margin: 0px; font-size: 19px; font-weight: normal; color: #9E8045; text-align: center; display: inline-block; border-top: 1px solid #9E8045; border-bottom: 1px solid #9E8045; padding: 10px; letter-spacing: 1px;",
      ...
      blockquote: "margin: 10px 0; padding: 8px; background: #fff; border: none; border-left: 2px solid #9E8045; text-align: center;",
