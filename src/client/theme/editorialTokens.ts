...
const editorialLightTokens = {
  ...
  radiusPill: "999px",
  bgPage: "#f8f2f8",
  bgPageGlowA: "radial-gradient(circle at 14% 16%, rgba(166, 85, 157, 0.20), transparent 28%)",
  bgPageGlowB: "radial-gradient(circle at 85% 18%, rgba(200, 143, 194, 0.16), transparent 24%)",
  bgPageGlowC: "radial-gradient(circle at 56% 78%, rgba(220, 180, 215, 0.12), transparent 28%)",
  gridLine: "linear-gradient(rgba(160, 130, 160, 0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(160, 130, 160, 0.08) 1px, transparent 1px)",
  scanline: "linear-gradient(180deg, rgba(255, 255, 255, 0.18) 0%, rgba(255, 255, 255, 0) 100%)",
  bgSidebar: "linear-gradient(180deg, rgba(248, 240, 248, 0.92) 0%, rgba(250, 245, 250, 0.92) 100%)",
  ...
  bgLink: "rgba(166, 85, 157, 0.08)",
  bgLinkActive: "linear-gradient(135deg, rgba(166, 85, 157, 0.16), rgba(200, 143, 194, 0.10))",
  bgLinkActiveStrong: "rgba(166, 85, 157, 0.22)",
  textMain: "#1a1520",
  textBody: "#3e3548",
  textMuted: "#7a6e88",
  textSidebar: "#1a1520",
  ...
  accent: "#a6559d",
  accentOrange: "#c07ab8",
  accentSoft: "rgba(166, 85, 157, 0.12)",
  border: "rgba(155, 130, 155, 0.20)",
  borderStrong: "rgba(140, 110, 140, 0.30)",
  ring: "rgba(166, 85, 157, 0.34)",
  success: "#2a9d8f",
  warning: "#d79b36",
  danger: "#df5f7c",
  shadowCard: "0 18px 44px rgba(80, 50, 80, 0.08)",
  shadowPage: "0 0 0 rgba(0, 0, 0, 0)",
  shadowFloating: "0 24px 60px rgba(60, 35, 60, 0.16)",
  shadowAccent: "0 16px 36px rgba(166, 85, 157, 0.18)"
...
const editorialDarkTokens = {
  ...
  radiusPill: "999px",
  bgPage: "#100a12",
  bgPageGlowA: "radial-gradient(circle at 16% 18%, rgba(166, 85, 157, 0.26), transparent 26%)",
  bgPageGlowB: "radial-gradient(circle at 84% 18%, rgba(200, 143, 194, 0.18), transparent 22%)",
  bgPageGlowC: "radial-gradient(circle at 62% 82%, rgba(220, 180, 215, 0.14), transparent 28%)",
  gridLine: "linear-gradient(rgba(170, 130, 170, 0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(170, 130, 170, 0.06) 1px, transparent 1px)",
  scanline: "linear-gradient(180deg, rgba(255, 255, 255, 0.08) 0%, rgba(255, 255, 255, 0) 100%)",
  bgSidebar: "linear-gradient(180deg, rgba(14, 8, 16, 0.96) 0%, rgba(18, 12, 20, 0.96) 100%)",
  bgSidebarPanel: "rgba(22, 16, 28, 0.72)",
  bgPanel: "rgba(18, 14, 26, 0.76)",
  bgPanelStrong: "rgba(22, 16, 28, 0.9)",
  bgControl: "rgba(22, 16, 32, 0.74)",
  bgControlHover: "rgba(32, 24, 44, 0.9)",
  bgLink: "rgba(201, 143, 195, 0.10)",
  bgLinkActive: "linear-gradient(135deg, rgba(201, 143, 195, 0.22), rgba(220, 180, 215, 0.12))",
  bgLinkActiveStrong: "rgba(201, 143, 195, 0.22)",
  textMain: "#ffffff",
  textBody: "#dbd0e6",
  textMuted: "#9486a6",
  textSidebar: "#ffffff",
  ...
  accent: "#c98fc3",
  accentOrange: "#d9a8d4",
  accentSoft: "rgba(201, 143, 195, 0.16)",
  border: "rgba(140, 110, 140, 0.26)",
  borderStrong: "rgba(170, 140, 170, 0.34)",
  ring: "rgba(201, 143, 195, 0.42)",
  success: "#6cd4b2",
  warning: "#ffbf63",
  danger: "#ff7f96",
  shadowCard: "0 18px 44px rgba(5, 2, 8, 0.34)",
  shadowPage: "0 0 0 rgba(0, 0, 0, 0)",
  shadowFloating: "0 28px 70px rgba(3, 2, 6, 0.4)",
  shadowAccent: "0 18px 44px rgba(201, 143, 195, 0.26)"
} as const satisfies EditorialThemeTokens;
