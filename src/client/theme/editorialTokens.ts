...
const editorialLightTokens = {
  ...
  radiusPill: "999px",
  bgPage: "#f4ede3",
  bgPageGlowA: "rgba(74, 99, 136, 0.08)",
  ...
  bgLink: "rgba(74, 99, 136, 0.07)",
  bgLinkActive: "linear-gradient(135deg, rgba(234, 239, 246, 0.96), rgba(245, 247, 250, 0.98))",
  bgLinkActiveStrong: "rgba(74, 99, 136, 0.08)",
  textMain: "#13233c",
  textBody: "#43546e",
  textMuted: "#6a7890",
  textSidebar: "#13233c",
  ...
  accent: "#4a6388",
  accentOrange: "#ff6a2a",
  accentSoft: "rgba(74, 99, 136, 0.16)",
  border: "rgba(19, 35, 60, 0.12)",
  borderStrong: "rgba(74, 99, 136, 0.24)",
  ring: "rgba(74, 99, 136, 0.16)",
  success: "#22624f",
  warning: "#ff6a2a",
  danger: "#b33a2c",
  ...
  shadowAccent: "0 0 0 1px rgba(74, 99, 136, 0.1), 0 12px 24px rgba(27, 40, 63, 0.1)"
...
const editorialDarkTokens = {
  ...
  radiusPill: "999px",
  bgPage: "#111722",
  bgPageGlowA: "rgba(155, 176, 211, 0.14)",
  ...
  bgLink: "rgba(155, 176, 211, 0.12)",
  bgLinkActive: "linear-gradient(135deg, rgba(34, 43, 60, 0.96), rgba(28, 37, 52, 0.98))",
  bgLinkActiveStrong: "rgba(155, 176, 211, 0.1)",
  textMain: "#eef3ff",
  textBody: "#c4cedf",
  textMuted: "#8f9bb2",
  textSidebar: "#eef3ff",
  ...
  accent: "#9bb0d3",
  accentOrange: "#ff9b6d",
  accentSoft: "rgba(155, 176, 211, 0.22)",
  border: "rgba(255, 255, 255, 0.1)",
  borderStrong: "rgba(155, 176, 211, 0.3)",
  ring: "rgba(155, 176, 211, 0.22)",
  success: "#58c8a1",
  warning: "#ff9b6d",
  danger: "#ff8f80",
  ...
  shadowAccent: "0 0 0 1px rgba(155, 176, 211, 0.16), 0 14px 28px rgba(8, 14, 24, 0.34)"
} as const satisfies EditorialThemeTokens;
