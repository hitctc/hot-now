...
describe("AiTimelineAdminPage", () => {
  ...
  it("renders the read-only feed workbench sections", async () => {
    ...
    expect(wrapper.get("[data-ai-timeline-admin-overview]").text()).toContain("04-24 18:00");
    ...
    expect(wrapper.get("[data-ai-timeline-candidate-events]").text()).toContain("04-24 18:00");
